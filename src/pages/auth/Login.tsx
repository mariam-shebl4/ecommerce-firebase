...
import { googleSignIn, loginUser } from '../../firebase/firebase';
import { useAppDispatch } from '../../stores/hooks';
import { loginSuccess, loginFailure } from '../../stores/authSlice';
import { mapFirebaseUserToAppUser } from '../../utils/userUtils';
      ...
      <SignInContainer direction="column" justifyContent="space-between">
        <Card variant="outlined">
          ...
          <Box component="form" onSubmit={handleSubmit} noValidate sx={{ display: 'flex', flexDirection: 'column', width: '100%', gap: 2 }}>
            ...
            <LinkMui component="button" type="button" onClick={handleClickOpen} variant="body2" sx={{ alignSelf: 'center' }}>
          ...
          <Box sx={{ display: 'flex', flexDirection: 'column', gap: 2 }}>
            ...
            <Typography sx={{ textAlign: 'center' }}>
              ...
              <Link to="/auth/Signup" style={{ alignSelf: 'center' }}>
                Sign up
              </Link>
            </Typography>
          </Box>
